...
from backend.backend.test.yolov5.utils import TryExcept
from backend.backend.test.yolov5.utils.dataloaders import exif_transpose, letterbox
...
from backend.backend.test.yolov5.utils.torch_utils import copy_attr, smart_inference_mode
...
class DetectMultiBackend(nn.Module):
    ...
    def __init__(self, weights="yolov5s.pt", device=torch.device("cpu"), dnn=False, data=None, fp16=False, fuse=True):
        ...
        from backend.backend.test.yolov5.models.experimental import attempt_download, attempt_load # scoped to avoid circular import
        ...
        if pt:  # PyTorch
            ...
            from backend.backend.test.yolov5.utils.triton import TritonRemoteModel
    ...
    def _model_type(p="path/to/model.pt"):
        ...
        from backend.backend.test.yolov5.export import export_formats

        from backend.backend.test.yolov5.utils.downloads import is_url
