...
from backend.backend.test.yolov5.utils import TryExcept, emojis
from backend.backend.test.yolov5.utils.downloads import curl_download, gsutil_getsize
from backend.backend.test.yolov5.utils.metrics import box_iou, fitness
...
def check_amp(model):
    ...
    from backend.backend.test.yolov5.models.common import AutoShape, DetectMultiBackend
