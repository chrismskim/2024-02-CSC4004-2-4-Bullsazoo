...
def notebook_init(verbose=True):
    ...
    from backend.backend.test.yolov5.utils.general import check_font, is_colab
    from backend.backend.test.yolov5.utils.torch_utils import select_device  # imports
