...
from backend.backend.test.yolov5.utils.general import LOGGER, TQDM_BAR_FORMAT, colorstr
...
def kmean_anchors(dataset="./data/coco128.yaml", n=9, img_size=640, thr=4.0, gen=1000, verbose=True):
    ...
    if isinstance(dataset, str):  # *.yaml file
        ...
        from backend.backend.test.yolov5.utils.dataloaders import LoadImagesAndLabels
