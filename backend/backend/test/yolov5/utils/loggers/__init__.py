...
from backend.backend.test.yolov5.utils.general import LOGGER, colorstr, cv2
from backend.backend.test.yolov5.utils.loggers.clearml.clearml_utils import ClearmlLogger
from backend.backend.test.yolov5.utils.loggers.wandb.wandb_utils import WandbLogger
from backend.backend.test.yolov5.utils.plots import plot_images, plot_labels, plot_results
from backend.backend.test.yolov5.utils.torch_utils import de_parallel
...
try:
    if RANK in {0, -1}:
        ...
        from backend.backend.test.yolov5.utils.loggers.comet import CometLogger
